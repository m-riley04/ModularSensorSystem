...
ActionGroup {
    ...
    Action {
        id: actionAddProcessor
        text: qsTr("Add Processor")
        icon.name: "list-add"
    }
    Action {
        id: actionRemoveProcessor
        text: qsTr("Remove Processor")
        icon.name: "list-remove"
    }
    Action {
        id: actionConfigureProcessor
        text: qsTr("Configure Processor")
        icon.name: "document-properties"
    }
    Action {
        id: actionToggleProcessing
        text: qsTr("Toggle Processing")
