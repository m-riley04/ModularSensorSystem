...
Item {
    ...
    ActionGroup {
        ...
        Action {
            ...
            text: qsTr("Restart")
            onTriggered: {
                // Call a restart function exposed from C++ (example)
    ...
    ActionGroup {
        id: actionsView
        Action { id: actionViewMenuBar; text: qsTr("Menu Bar"); checkable: true; }
        Action { id: actionViewToolbar; text: qsTr("Toolbar"); checkable: true; }
        Action { id: actionViewCustomWindowHandle; text: qsTr("Custom Window Handle"); checkable: true; }
    }

    ActionGroup {
        id: actionsViewControlRow
        Action { id: actionViewControlRowPresetList; text: qsTr("Preset List"); checkable: true; }
        Action { id: actionViewControlRowSourcesList; text: qsTr("Sources List"); checkable: true; }
        Action { id: actionViewControlRowProcessorsList; text: qsTr("Processors List"); checkable: true; }
        Action { id: actionViewControlRowControls; text: qsTr("Controls"); checkable: true; }
        Action { id: actionViewControlRowEntireRow; text: qsTr("Entire Row"); checkable: true; }
    }
    ...
    ActionGroup {
        id: actionsHelp
        Action { id: actionHelp; text: qsTr("Help") }
    }
}
